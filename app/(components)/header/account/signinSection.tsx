export default function SigninSection({ setIsLogin }: { setIsLogin: React.Dispatch<React.SetStateAction<boolean>> }) {
  return (
    <div
      className="
        flex flex-wrap justify-between
        absolute right-4 sm:right-16 mt-2
        bg-zinc-800 border border-green-900 rounded-xl p-4
        w-[80vw] xl:max-w-[700px]
        shadow-xl z-50
        left-4 sm:left-auto
      "
    ...
    >
      ...
      <form className="flex flex-col space-y-3 w-full sm:w-[45%]">
        <input
          type="email"
          placeholder="Email"
        ...
        <div>
          <input
            type="checkbox"
            id="remember"
            className="checked:accent-green-700 hover:cursor-pointer"
          />
          <label className="text-white hover:cursor-pointer ml-2" htmlFor="remember">
            Remember me
          </label>
          <p className="ml-8 mt-1 text-[.9em] italic">
        ...
        <button className="text-blue-300 italic ml-auto mt-1 hover:cursor-pointer">
