export default function ContentSection() {
    return (
              <section className="px-6 py-16 max-w-5xl mx-auto text-zinc-100">
        <h2 className="font-[UncialAntiqua] text-4xl font-bold text-yellow-100 mb-12 text-center">
          Loaded with content
        </h2>

        <div className="space-y-16 text-lg leading-relaxed font-[EBGaramond]">

          <div>
            <h3 className="font-[Almendra] text-2xl font-semibold text-yellow-200 mb-3">
          ...
          <div>
            <h3 className="font-[Almendra] text-2xl font-semibold text-yellow-200 mb-3">
              One million square kilometers of procedurally generated landscapes
            </h3>
            <p className='font-[EBGaramond] text-[1.3em]'>
